import { init } from 'puppybowl-workshop/node_modules/es-module-lexer';
import { fetchAllPlayers, fetchSinglePlayer } from './ajaxHelpers.js';
...
export const renderNewPlayerForm = () => {
  ...
  form.addEventListener('submit', async (event) => {
    ...
    let playerData = {
      ...
      breed: form.element.breed.value
    }
  });
};
